...
@Component({
  selector: 'app-glaring-ball4',
  standalone: true,
  imports: [],
  templateUrl: './glaring-ball4.component.html',
  styleUrl: './glaring-ball4.component.css'
})
export class GlaringBall4Component implements OnInit {
  constructor() {}
