...
@Component({
  ...
  standalone: true,
  imports: [BouncingBallComponent, MovingBallComponent, FollowingBallComponent, GlaringBallComponent, GlaringBallComponentTry2, GlaringBallComponentTry3Squeeking],
